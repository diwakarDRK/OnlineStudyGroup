...
<link rel="stylesheet" href="https://fonts.googleapis.com/cssd?family=Raleway">
...
<a href="#home" class="w3-bar-item w3-button"><i class="fa fa-home w3-text-grey w3-hover-text-purple fa-2x  "></i></a>
    ...
    <a href="signin.php" class="w3-bar-item w3-button"><i class="fa fa-user w3-hover-text-indigo fa-2x"></i> SIGN IN</a>

   <a href="#BLOG" class="w3-bar-item w3-button"><i class="fa fa-pencil-square-o w3-hover-text-green fa-2x"></i>BLOG</a> 

      <a href="#pricing" class="w3-bar-item w3-button" title="pricing"><i class="fa fa-inr w3-hover-text-orange fa-2x"></i></a>
...
<div class="w3-container" style="padding:128px 16px" id="BLOG">
  ...
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    ...
    <div class="w3-quarter">
      ...
      <br />
      <a href="signin.php">Go to the blog section</a>
    </div>
  </div>
</div>
  ...
  <div class="w3-row-padding w3-grayscale">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card-2">
        ...
        <div class="w3-container">
          <h3>Rahul Nayak</h3>
          <p class="w3-opacity">MD & Designer & Co-Founder</p>
